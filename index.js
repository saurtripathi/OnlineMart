...
let totalIndividualItemPriceForEarBud = 0
let totalIndividualItemPriceForWiredEarphone = 0
let totalIndividualItemPriceForUsbCable = 0
...
document.addEventListener('submit',handlePayBtnClick)
...
function getTotal(productId){
   ...
   total += Number(document.getElementById('total_price').textContent.substring(1).trim())
...
function render() {
    ...
    main.innerHTML += `       
                            <div id="checkout-section" class="checkout-section hide">
                                <p class="order-detail">Total bill</p>
                            </div> 
